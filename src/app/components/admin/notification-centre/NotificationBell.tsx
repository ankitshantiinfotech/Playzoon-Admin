...
function NotifIcon({
  ...
  return (
    <div
      className={cn(
        "w-9 h-10 rounded-xl flex items-center justify-center shrink-0 relative",
        cfg.color,
      )}
    >
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-2 mt-1">
          ...
          {notif.priority === "critical" && (
            <span className="text-[10px] text-red-600 bg-red-50 border border-red-200 px-1.5 py-0.5 rounded-full font-semibold">
              Critical
            </span>
          )}
  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className={cn(
          "relative w-9 h-10 flex items-center justify-center rounded-xl transition-colors",
          open
