...
const INITIAL_EVENTS: EventConfig[] = [
  {
    ...
    description: "When a booking is successfully confirmed",
    push: true,
    email: true,
    inApp: true,
  },
  {
    ...
    description: "When a booking is cancelled by user or provider",
    push: true,
    email: true,
    inApp: true,
  },
  ...
  {
    id: "tournament_joined",
    name: "Tournament Joined",
    description: "When a player joins a tournament",
    push: true,
    email: false,
    inApp: true,
  },
  ...
  },
  {
    ...
    description: "When a provider payout is completed",
    push: true,
    email: true,
    inApp: true,
  },
  {
    id: "training_booked",
    name: "Training Booked",
    description: "When a training session is booked",
    push: true,
    email: true,
    inApp: true,
  },
  {
    ...
    description: "When wallet balance is topped up",
    push: true,
    email: false,
    inApp: true,
  },
  {
    id: "promotion_activated",
    name: "Promotion Activated",
    description: "When a promotional offer is activated",
    push: true,
    email: true,
    inApp: false,
  },
  {
    ...
    description: "When a provider account is verified",
    push: false,
    email: true,
    inApp: true,
  },
...
const INITIAL_TEMPLATES: NotificationTemplate[] = [
  {
    ...
    bodyEn:
      "Hi {player_name}, your booking #{booking_id} at {facility_name} on {date} at {time} has been confirmed.",
    bodyAr:
      "مرحباً {player_name}، تم تأكيد حجزك #{booking_id} في {facility_name} بتاريخ {date} الساعة {time}.",
  },
  {
    id: "tpl_2",
    ...
    bodyEn:
      "Hi {player_name}, your booking #{booking_id} on {date} has been cancelled. Amount {amount} will be refunded.",
    bodyAr:
      "مرحباً {player_name}، تم إلغاء حجزك #{booking_id} بتاريخ {date}. سيتم استرداد المبلغ {amount}.",
  },
  {
    id: "tpl_3",
    ...
    bodyEn:
      "Hi {player_name}, your payment of {amount} has been received successfully on {date}.",
    bodyAr:
      "مرحباً {player_name}، تم استلام دفعتك بمبلغ {amount} بنجاح بتاريخ {date}.",
  },
  {
    id: "tpl_4",
    ...
    bodyEn:
      "Hi {player_name}, you've successfully joined {tournament_name} on {date}. Good luck!",
    bodyAr:
      "مرحباً {player_name}، لقد انضممت بنجاح إلى {tournament_name} بتاريخ {date}. بالتوفيق!",
  },
  {
    id: "tpl_5",
    ...
    bodyEn:
      "Hi {provider_name}, you received a new review for {facility_name} from {player_name}.",
    bodyAr:
      "مرحباً {provider_name}، لقد استلمت تقييماً جديداً لـ {facility_name} من {player_name}.",
  },
  {
    id: "tpl_6",
    ...
    bodyEn:
      "Hi {provider_name}, your payout of {amount} has been processed on {date}.",
    bodyAr:
      "مرحباً {provider_name}، تم معالجة دفعتك بمبلغ {amount} بتاريخ {date}.",
  },
  {
    id: "tpl_7",
    ...
    bodyEn:
      "Hi {player_name}, your training session at {facility_name} on {date} at {time} is confirmed.",
    bodyAr:
      "مرحباً {player_name}، تم تأكيد جلستك التدريبية في {facility_name} بتاريخ {date} الساعة {time}.",
  },
  {
    id: "tpl_8",
    ...
    bodyEn:
      "Hi {player_name}, your wallet has been recharged with {amount} on {date}.",
  ...
  },
  {
    ...
    bodyEn:
      "Hi {player_name}, a new promotion is now active at {facility_name}. Book now and save!",
    bodyAr:
      "مرحباً {player_name}، عرض ترويجي جديد متاح الآن في {facility_name}. احجز الآن ووفر!",
  },
  {
    id: "tpl_10",
    ...
    bodyEn:
      "Hi {provider_name}, your account has been verified on {date}. You can now start receiving bookings.",
    bodyAr:
      "مرحباً {provider_name}، تم التحقق من حسابك بتاريخ {date}. يمكنك الآن البدء في استقبال الحجوزات.",
  },
];
...
function PreviewPanel({ template }: { template: NotificationTemplate }) {
  ...
  const eventName =
    INITIAL_EVENTS.find((e) => e.id === template.eventTypeId)?.name ||
    "Notification";
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="rounded-xl bg-white border border-gray-200 shadow-sm p-4 space-y-1">
          ...
          <p className="text-sm text-gray-900">
            {resolveTokens(template.titleEn) || "Notification Title"}
          </p>
          <p className="text-xs text-gray-500 line-clamp-2">
            {resolveTokens(template.bodyEn) || "Notification body goes here..."}
          </p>
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        <div
          className="rounded-xl bg-white border border-gray-200 shadow-sm p-4 space-y-1"
          dir="rtl"
        >
          <div className="flex items-center gap-2 mb-1.5">
            <div className="w-5 h-5 rounded-md bg-[#003B95] flex items-center justify-center">
          ...
          <p className="text-sm text-gray-900">
            {resolveTokens(template.titleAr) || "عنوان الإشعار"}
          </p>
          <p className="text-xs text-gray-500 line-clamp-2">
            {resolveTokens(template.bodyAr) || "نص الإشعار هنا..."}
          </p>
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="rounded-xl border border-gray-200 overflow-hidden shadow-sm">
          ...
          <div className="bg-white p-4 space-y-2">
            <p className="text-sm text-gray-900">
              {resolveTokens(template.titleEn) || "Email Subject"}
            </p>
            <div className="border-t border-gray-100 pt-2">
              <p className="text-xs text-gray-600 whitespace-pre-wrap">
                {resolveTokens(template.bodyEn) || "Email body goes here..."}
              </p>
            </div>
          </div>
          <div className="bg-gray-50 px-4 py-2 border-t border-gray-100">
            <p className="text-[10px] text-gray-400 text-center">
              © 2026 Playzoon. All rights reserved.
            </p>
          </div>
        </div>
      </div>
  ...
  const handleInsertToken = useCallback(
    (token: string) => {
      ...
      if (textarea) {
        ...
        const currentValue =
          activeBodyField === "en" ? template.bodyEn : template.bodyAr;
        const newValue =
        ...
        <div className="xl:col-span-3 space-y-5">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(val) =>
                onChange({ ...template, eventTypeId: val })
              }
            >
              <SelectTrigger>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  onChange({ ...template, titleEn: e.target.value })
                }
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  onChange({ ...template, titleAr: e.target.value })
                }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Textarea
                ...
                onChange={(e) =>
                  onChange({ ...template, bodyEn: e.target.value })
                }
                placeholder="Enter English notification body..."
                className="min-h-[120px]"
              />
              {errors.bodyEn && (
                <p className="text-xs text-red-500">{errors.bodyEn}</p>
              )}
            </div>
            <div className="space-y-2">
              <Label
              ...
              <Textarea
                ...
                onChange={(e) =>
                  onChange({ ...template, bodyAr: e.target.value })
                }
              ...
              />
              {errors.bodyAr && (
                <p className="text-xs text-red-500">{errors.bodyAr}</p>
              )}
            </div>
          </div>
          ...
          <p className="text-xs text-gray-400">
            Tokens will insert into:{" "}
            <span className="text-[#003B95]">
              {activeBodyField === "en" ? "Body (EN)" : "Body (AR)"}
            </span>
          </p>
          ...
          >
            <div className="flex-1 min-w-0 space-y-1">
              <div className="flex items-center gap-2">
                ...
                <Badge
                  variant="secondary"
                  className="text-[10px] shrink-0 bg-[#003B95]/10 text-[#003B95] border-[#003B95]/20"
                >
...
export function NotificationSettings() {
  ...
  const [templates, setTemplates] =
    useState<NotificationTemplate[]>(INITIAL_TEMPLATES);
  ...
  const handleToggle = (
    ...
    setEvents((prev) =>
      prev.map((e) =>
        e.id === eventId ? { ...e, [channel]: !e[channel] } : e,
      ),
    );
  };
  ...
  const handleSaveTemplate = () => {
    ...
    if (!editingTemplate.titleEn.trim())
      errors.titleEn = "Title (EN) is required";
    if (!editingTemplate.titleAr.trim())
      errors.titleAr = "Title (AR) is required";
    ...
    <div className="p-6 space-y-5 bg-[#F9FAFB] min-h-screen">
      <div>
        ...
        <p className="text-muted-foreground">
          Configure event-based notifications, channels, and bilingual
          templates.
        </p>
      </div>
      ...
      <Tabs defaultValue="events" className="space-y-6">
        <TabsList className="bg-gray-100 p-1 rounded-xl">
          <TabsTrigger
            value="events"
            className="gap-2 data-[state=active]:bg-white data-[state=active]:shadow-sm rounded-lg px-4"
          >
        ...
        <TabsContent value="events">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Control which channels (Push, Email, In-App) are active for each
                event type. Changes affect all platform users.
              </CardDescription>
            </CardHeader>
          ...
          {editingTemplateId && editingTemplate ? (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Modify the notification template content for both English and
                  Arabic. Use token chips to insert dynamic values.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <TemplateEditor
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Manage bilingual notification templates. Click a template to
                  edit its content and preview.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <TemplateList
