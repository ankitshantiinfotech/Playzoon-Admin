...
export function PlayerReportTab({ filters }: Props) {
  const kpis = useMemo(
    () => PLAYER_KPIS[filters.preset] ?? PLAYER_KPIS["30d"],
    [filters.preset],
  );
  const trend = useMemo(
    () =>
      PLAYER_REGISTRATION_TREND[filters.preset] ??
      PLAYER_REGISTRATION_TREND["30d"],
    [filters.preset],
  );
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-xs text-gray-400">
                Daily / weekly trend for selected period
              </p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5 flex flex-col gap-5">
          ...
          <div className="flex flex-col items-center">
            <div className="relative h-[140px] w-[140px]">
                ...
                <PieChart>
                  <Pie
                    data={[
                      ...
                      {
                        name: "Other",
                        value: 100 - kpis.retentionRate - kpis.churnRate,
                      },
                    ]}
                    cx="50%"
                    cy="50%"
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                <span className="text-xl text-gray-900 tabular-nums">
                  {kpis.retentionRate}%
                </span>
          ...
          <div className="bg-[#003B95]/5 rounded-lg p-3 text-center border border-[#003B95]/10">
            ...
            <p className="text-xl text-[#003B95] tabular-nums mt-0.5">
              {kpis.activeTotal.toLocaleString()}
            </p>
          </div>
        </div>
      </div>
