...
export function PromotionsSection() {
  const totalPromotionRevenue = promotionTypes.reduce((acc, curr) => acc + curr.revenue, 0);
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm flex flex-col items-center min-w-0 overflow-hidden">
          <h3 className="text-lg font-medium text-gray-900 mb-4 self-start">Promotion Revenue</h3>
          <div className="h-[200px] w-full relative overflow-hidden">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center pointer-events-none">
              <span className="text-xl font-bold text-gray-900">{totalPromotionRevenue.toLocaleString()}</span>
        ...
        <div className="flex flex-col gap-6 lg:col-span-1 min-w-0">
          <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm flex-1 flex flex-col justify-center items-center text-center">
            ...
            <p className="text-sm text-gray-500 mt-1 uppercase tracking-wide font-medium">Active Promotions</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm flex-1 flex flex-col justify-center items-center text-center">
            ...
            <p className="text-sm text-gray-500 mt-1 uppercase tracking-wide font-medium">Total Refreshes (Week)</p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm lg:col-span-1 min-w-0 overflow-hidden">
          <h3 className="text-lg font-medium text-gray-900 mb-4">Refresh Activity Trend</h3>
