    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm flex flex-col justify-between">
          <div>
            <p className="text-sm font-medium text-gray-500 uppercase">Total Paid Out</p>
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm flex flex-col justify-between">
          <div>
            ...
            <h3 className="text-3xl font-bold text-amber-600 mt-2">45,000 SAR</h3>
          </div>
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm flex flex-col justify-between">
          <div>
            <p className="text-sm font-medium text-gray-500 uppercase">Avg. Processing Time</p>
            <h3 className="text-3xl font-bold text-blue-600 mt-2">1.5 Days</h3>
          </div>
          <div className="mt-4 text-sm text-gray-500">
            Within 24-48h target
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm flex flex-col items-center justify-center min-w-0 overflow-hidden">
          <h3 className="text-sm font-medium text-gray-900 mb-2 w-full text-left">Payout Status</h3>
