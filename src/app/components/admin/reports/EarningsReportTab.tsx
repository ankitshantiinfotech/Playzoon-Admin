...
export function EarningsReportTab({ filters }: Props) {
  const kpis = useMemo(
    () => EARNINGS_KPIS[filters.preset] ?? EARNINGS_KPIS["30d"],
    [filters.preset],
  );
  const commTrend = useMemo(
    () => COMMISSION_TREND[filters.preset] ?? COMMISSION_TREND["30d"],
    [filters.preset],
  );

  const totalCommission = COMMISSION_BY_TYPE.reduce(
    (a, b) => a + b.commission,
    0,
  );
        ...
        <div className="lg:col-span-2 bg-white rounded-xl border border-gray-200 p-5">
          <div className="mb-4">
            ...
            <p className="text-xs text-gray-400">
              AED earned as platform commission per data point
            </p>
          </div>
          <div className="h-[240px]">
            <SafeChart height={240}>
              ...
              >
                ...
                <Tooltip
                  {...TOOLTIP_STYLE}
                  formatter={(v: number) => [fmtAED(v), "Commission"]}
                />
                <Line
                  type="monotone"
                  dataKey="value"
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5 flex flex-col gap-4">
          ...
          <div className="space-y-3">
            ...
            <div className="border-t pt-3 flex items-center justify-between">
              ...
              <span className="text-sm text-violet-600 tabular-nums">
                {fmtAED(kpis.netEarnings)}
              </span>
            </div>
          </div>
          ...
          <div className="bg-violet-50 border border-violet-100 rounded-lg p-3">
            ...
            <div className="mt-2 h-1.5 bg-violet-100 rounded-full overflow-hidden">
              <div
                ...
                style={{
                  width: `${(kpis.netEarnings / kpis.totalCommission) * 100}%`,
                }}
              />
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          ...
          <p className="text-xs text-gray-400 mb-5">
            AED earned per booking type with effective commission rate
          </p>
          <div className="h-[240px]">
            <SafeChart height={240}>
              <BarChart
              ...
              >
                ...
                <Legend
                  formatter={(v) =>
                    v === "commission" ? "Commission" : "Gross Revenue"
                  }
                  iconType="circle"
                  iconSize={8}
                />
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          ...
          <p className="text-xs text-gray-400 mb-5">
            Distribution of provider payout statuses
          </p>
            ...
            <div className="relative h-[180px] w-[180px] shrink-0">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                ...
                <span className="text-sm text-gray-900">
                  {fmtAED(kpis.payoutDisbursed + kpis.payoutPending)}
                </span>
              </div>
            </div>
