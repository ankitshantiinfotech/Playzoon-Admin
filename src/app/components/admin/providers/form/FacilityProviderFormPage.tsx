...
import {
  ...
  validateWebsite,
  formatFileSize,
  getFacilityProviderDetail,
  generateProviderId,
  validateAboutFacility,
  validateFacilityRules,
  validateCancellationPolicy,
  validateTimeRange,
  getWorkingDaysWarning,
  TIME_SLOTS,
  WEEKDAYS,
  validateProviderId,
  ...
  type FacilityFieldErrors,
  type FacilityTouchedFields,
  type UploadedFile,
  type Weekday,
...
export function FacilityProviderFormPage() {
    ...
    import("@/services/admin.service").then(({ adminService }) => {
      adminService
        ...
        .then((res: Record<string, unknown>) => {
          ...
          const desig = pr.designation as
            | Record<string, unknown>
            | string
            | null;
          const desigStr =
            typeof desig === "object" && desig
              ? String(desig.name_en || "")
              : String(desig || "");
          const formData: FacilityFormState = {
            ...
            incorporationDate: pr.date_of_incorporation
            ...
            platformStatus:
              String(pr.status) === "active" ? "Active" : "Inactive",
          ...
          initialFormRef.current = JSON.stringify({
            ...formData,
            incorporationDate:
              formData.incorporationDate?.toISOString() ?? null,
  ...
  const validateField = useCallback(
    (
      field: keyof FacilityFormState | "timeRange",
      value: unknown,
    ): string | null => {
      switch (field) {
        case "facilityName":
          return validateFacilityName(value as string);
        ...
        case "personInCharge":
          return validatePersonInCharge(value as string);
        case "designation":
          return validateDesignation(value as string);
        case "landline":
          return validateLandline(value as string);
        case "website":
          return validateWebsite(value as string);
        case "aboutFacility":
          return validateAboutFacility(value as string);
        case "facilityRules":
          return validateFacilityRules(value as string);
        case "cancellationPolicy":
          return validateCancellationPolicy(value as string);
        case "providerId":
          return validateProviderId(value as string);
        case "registrationNumber":
          return validateRegistrationNumber(value as string);
        case "taxId":
          return validateTaxId(value as string);
        case "businessLicense":
          return validateBusinessLicense(value as string);
        default:
          return null;
      }
    },
  ...
  const handleBlur = useCallback(
    (field: keyof FacilityFormState | "timeRange") => {
      ...
      const error = validateField(
        field,
        form[field as keyof FacilityFormState],
      );
    ...
    return (
      ...
      >
        <div className="flex items-center gap-3">
          <Skeleton className="h-10 w-9 rounded-md" />
    ...
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <p className="text-sm text-gray-500 mb-4">
          The facility provider you're looking for does not exist.
        </p>
        ...
        <div className="bg-white rounded-xl border border-gray-200 divide-y divide-gray-100">
          ...
          <div className="p-6 space-y-5">
                ...
                <PopoverContent className="w-auto p-0" align="start">
                  <Calendar
                    ...
                    onSelect={(date) => {
                      ...
                      setErrors((prev) => ({
                        ...prev,
                        incorporationDate: err ?? undefined,
                      }));
                    }}
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-[11px] text-gray-400">
                  {form.personInCharge.length}/150
                </span>
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              />
              {touched.landline && errors.landline ? (
                <p id="landline-error" className="text-[11px] text-red-500">
                  {errors.landline}
                </p>
              ) : (
                <p className="text-[11px] text-gray-400">
                  7-15 digits. Numeric only.
                </p>
              )}
            </div>
            ...
            <div className="space-y-1.5">
              ...
              {touched.website && errors.website ? (
                <p id="website-error" className="text-[11px] text-red-500">
                  {errors.website}
                </p>
              ) : (
                <p className="text-[11px] text-gray-400">
          ...
          <div className="p-6 space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex justify-between">
                ...
                <span
                  id="aboutFacility-count"
                  className={cn(
                    "text-[11px]",
                    form.aboutFacility.length > 4800
                      ? "text-amber-500"
                      : "text-gray-400",
                  )}
                >
            ...
            <div className="space-y-2">
              ...
              {/* Soft warning */}
              {(() => {
                const warning = getWorkingDaysWarning(
                  form.openingTime,
                  form.closingTime,
                  form.workingDays,
                );
            ...
            <div className="space-y-1.5">
              ...
              <Textarea
                ...
                className={cn(
                  "min-h-[100px] text-sm",
                  touched.facilityRules &&
                    errors.facilityRules &&
                    "border-red-400 focus-visible:ring-red-200",
                )}
              ...
              <div className="flex justify-between">
                ...
                <span
                  id="facilityRules-count"
                  className={cn(
                    "text-[11px]",
                    form.facilityRules.length > 4800
                      ? "text-amber-500"
                      : "text-gray-400",
                  )}
                >
              ...
              <Textarea
                ...
                aria-describedby={
                  touched.cancellationPolicy && errors.cancellationPolicy
                    ...
                    : "cancellationPolicy-count"
                }
              />
              <div className="flex justify-between">
                {touched.cancellationPolicy && errors.cancellationPolicy ? (
                  <p
                    id="cancellationPolicy-error"
                    className="text-[11px] text-red-500"
                  >
                    {errors.cancellationPolicy}
                  </p>
                ...
                <span
                  id="cancellationPolicy-count"
                  className={cn(
                    "text-[11px]",
                    form.cancellationPolicy.length > 4800
                      ? "text-amber-500"
                      : "text-gray-400",
                  )}
                >
          ...
          <div className="p-6 space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-[11px] text-gray-400">
                Locking an account will prevent the provider from accessing the
                platform.
              </p>
            </div>
          ...
          <div className="p-6 space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex justify-between">
                {touched.providerId && errors.providerId ? (
                  <p id="providerId-error" className="text-[11px] text-red-500">
                    {errors.providerId}
                  </p>
                ) : (
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-[11px] text-gray-400">
                  {form.registrationNumber.length}/50
                </span>
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                aria-describedby={
                  touched.taxId && errors.taxId ? "taxId-error" : undefined
                }
              />
              <div className="flex justify-between">
                {touched.taxId && errors.taxId ? (
                  <p id="taxId-error" className="text-[11px] text-red-500">
                    {errors.taxId}
                  </p>
                ) : (
                  <span />
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-[11px] text-gray-400">
                  {form.businessLicense.length}/100
                </span>
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex items-center gap-3">
                {form.createdAt ? (
                  <div
                    className="h-10 px-3 flex items-center rounded-lg border border-gray-200 bg-gray-50 text-sm text-gray-500 cursor-not-allowed select-none w-full"
                  ...
                  <div
                    className="h-10 px-3 flex items-center rounded-lg border border-dashed border-gray-200 bg-gray-50/50 text-sm text-gray-400 italic w-full"
            ...
            {documents.length > 0 ? (
              ...
              <div className="flex flex-col items-center py-4 text-center">
                ...
                <p className="text-[11px] text-gray-300 mt-0.5">
                  Upload supporting documents such as trade licenses,
      ...
      <AlertDialog open={lockDialogOpen} onOpenChange={setLockDialogOpen}>
        <AlertDialogContent className="sm:max-w-md">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Locking this account will prevent the provider from accessing the
              platform. This action can be reversed by unlocking the account
              later.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
